(this.wordle = this.wordle || {}),
  (this.wordle.bundle = (function (e) {
    ...
    var La = ['guild', 'rouge', 'abbey', 'metal', 'spilt', 'leafy', 'gumbo', 'ether', 'conic', 'folly', 'quell', 'tacky', 'bring', 'flail', 'budge', 'thank', 'talon', 'earth', 'apnea', 'hatch', 'flown', 'snowy', 'mouth', 'field', 'posse', 'count', 'faint', 'irony', 'agony', 'aloft', 'bleed', 'story', 'ghost', 'beget', 'flair', 'antic', 'belie', 'alive', 'greed', 'dross', 'wryly', 'basin', 'fussy', 'sinew', 'dutch', 'shrew', 'spray', 'adapt', 'debar', 'scent', 'hedge', 'pluck', 'detox', 'thing', 'louse', 'pagan', 'front', 'gaudy', 'sober', 'conch', 'proud', 'frank', 'clone', 'belch', 'photo', 'fiber', 'marsh', 'flour', 'sassy', 'buyer', 'muddy', 'level', 'alarm', 'grave', 'glass', 'world', 'stare', 'court', 'junta', 'timer', 'mange', 'lithe', 'sugar', 'impel', 'worry', 'forgo', 'admit', 'mafia', 'harry', 'login', 'skate', 'doubt', 'value', 'skiff', 'warty', 'macaw', 'inept', 'crony', 'taunt', 'parka', 'third', 'fixer', 'sauna', 'scuba', 'white', 'befit', 'breed', 'avian', 'bylaw', 'baggy', 'ripen', 'blimp', 'pasta', 'repay', 'quasi', 'flame', 'leech', 'ghoul', 'syrup', 'epoxy', 'grasp', 'pulse', 'moody', 'shawl', 'ditch', 'tumor', 'bloat', 'wispy', 'ferry', 'guise', 'pearl', 'smoky', 'glory', 'mealy', 'rotor', 'gouge', 'dwell', 'pecan', 'wager', 'steep', 'lapel', 'bride', 'blade', 'toxin', 'spade', 'ultra', 'cycle', 'cried', 'dwarf', 'whose', 'taste', 'crisp', 'berry', 'mince', 'woman', 'spoof', 'leant', 'booby', 'timid', 'tempo', 'trawl', 'blend', 'lipid', 'chore', 'exact', 'rarer', 'enjoy', 'jiffy', 'dryer', 'treat', 'ruddy', 'gecko', 'voice', 'swirl', 'urine', 'prior', 'visit', 'musky', 'solid', 'nerve', 'turbo', 'never', 'gayer', 'widow', 'flesh', 'lasso', 'jerky', 'quiet', 'geeky', 'pedal', 'cause', 'basic', 'dingo', 'knack', 'yield', 'sneer', 'grate', 'creep', 'aptly', 'avoid', 'shied', 'bleak', 'baler', 'phone', 'steer', 'woody', 'entry', 'chaos', 'quilt', 'gravy', 'dream', 'delay', 'vinyl', 'liver', 'drool', 'semen', 'onion', 'chord', 'truly', 'rough', 'shalt', 'arose', 'ester', 'crook', 'swine', 'trail', 'batch', 'leash', 'bulge', 'deter', 'hyena', 'motto', 'lurid', 'under', 'coupe', 'drift', 'quart', 'think', 'brunt', 'golem', 'oxide', 'skulk', 'beady', 'mover', 'cabal', 'eying', 'dance', 'canal', 'embed', 'daily', 'voter', 'civic', 'slept', 'serum', 'grove', 'mason', 'flick', 'bible', 'strip', 'agora', 'night', 'lapse', 'merit', 'gonad', 'hound', 'cloud', 'slush', 'spent', 'image', 'usher', 'vixen', 'glare', 'snarl', 'viral', 'caddy', 'opera', 'royal', 'outer', 'foamy', 'fecal', 'rabbi', 'crone', 'trial', 'crept', 'drier', 'frill', 'shire', 'bushy', 'genre', 'claim', 'trunk', 'strut', 'skirt', 'lefty', 'rebel', 'spare', 'theme', 'paler', 'droop', 'towel', 'riser', 'unfed', 'thorn', 'goody', 'shale', 'realm', 'sixty', 'poise', 'honor', 'payer', 'lynch', 'nadir', 'stole', 'uncle', 'cacti', 'ozone', 'gamer', 'ovary', 'plead', 'undid', 'slang', 'coyly', 'kiosk', 'handy', 'thigh', 'feral', 'torch', 'tryst', 'donut', 'bench', 'blame', 'bingo', 'fence', 'green', 'dense', 'stein', 'humus', 'write', 'shack', 'early', 'mound', 'genie', 'soggy', 'prime', 'frisk', 'award', 'train', 'shelf', 'armor', 'react', 'usurp', 'media', 'slink', 'tooth', 'label', 'larva', 'blare', 'canon', 'duvet', 'study', 'torus', 'vogue', 'spear', 'eager', 'canoe', 'waltz', 'teach', 'agree', 'rupee', 'while', 'cleft', 'drunk', 'grope', 'craze', 'bowel', 'elbow', 'gland', 'stout', 'crump', 'libel', 'chunk', 'false', 'quill', 'aorta', 'slyly', 'poppy', 'scope', 'least', 'bossy', 'ionic', 'billy', 'iliac', 'sense', 'freer', 'knock', 'shoot', 'murky', 'wrong', 'decor', 'honey', 'queen', 'surge', 'porch', 'tamer', 'irate', 'quail', 'stomp', 'tipsy', 'wordy', 'tonga', 'stick', 'topaz', 'spark', 'crack', 'butch', 'amend', 'choke', 'forum', 'wider', 'bread', 'prism', 'boast', 'leave', 'wreak', 'plane', 'pesky', 'parry', 'youth', 'lowly', 'shift', 'sepia', 'newer', 'boney', 'ethic', 'fifty', 'spunk', 'nasal', 'horny', 'those', 'drill', 'wight', 'laden', 'first', 'farce', 'teeth', 'spasm', 'mimic', 'token', 'motif', 'twice', 'solve', 'ashen', 'recap', 'whoop', 'limit', 'spoke', 'truth', 'glint', 'often', 'slide', 'droll', 'clued', 'spawn', 'labor', 'tread', 'trade', 'unite', 'brace', 'eking', 'ovine', 'prong', 'dowdy', 'enter', 'abide', 'scary', 'rower', 'aping', 'stilt', 'bluff', 'chief', 'bosom', 'inert', 'lathe', 'buddy', 'exist', 'villa', 'quest', 'heart', 'route', 'retry', 'diode', 'knoll', 'sleet', 'sulky', 'pouty', 'cynic', 'medic', 'serif', 'amber', 'ladle', 'giant', 'nicer', 'robot', 'wring', 'wooer', 'blood', 'kneed', 'augur', 'depot', 'anode', 'valid', 'twirl', 'crash', 'grass', 'stash', 'swami', 'easel', 'nymph', 'habit', 'haven', 'tribe', 'plunk', 'shape', 'mamma', 'sally', 'niche', 'synod', 'whelp', 'equal', 'taken', 'spiky', 'snuff', 'opine', 'gloom', 'brute', 'hoist', 'would', 'stove', 'alpha', 'proof', 'china', 'tenor', 'color', 'sissy', 'vegan', 'video', 'slant', 'human', 'flier', 'angst', 'devil', 'toast', 'penny', 'weedy', 'smash', 'scald', 'scoff', 'pesto', 'suave', 'palsy', 'bayou', 'humid', 'begun', 'forge', 'bland', 'locus', 'dowry', 'money', 'tango', 'egret', 'twang', 'sniff', 'rigor', 'theft', 'affix', 'crimp', 'biome', 'tawny', 'freak', 'maker', 'piney', 'raspy', 'rodeo', 'waver', 'grade', 'loser', 'swing', 'queer', 'melon', 'creed', 'pleat', 'renal', 'nanny', 'heist', 'sonar', 'hover', 'cubic', 'rugby', 'flyer', 'covet', 'rider', 'fatty', 'magic', 'lymph', 'belle', 'trust', 'smirk', 'risen', 'quack', 'petty', 'friar', 'cling', 'lodge', 'shone', 'retro', 'mambo', 'tweet', 'hoard', 'flume', 'troop', 'weave', 'scrum', 'throw', 'heron', 'gnash', 'spelt', 'chard', 'joker', 'unwed', 'tough', 'tract', 'glide', 'flaky', 'brave', 'hydro', 'saner', 'crazy', 'quick', 'wiser', 'nudge', 'grant', 'since', 'midge', 'grand', 'shout', 'skimp', 'roost', 'shore', 'broom', 'stung', 'taint', 'waive', 'eaten', 'sling', 'party', 'gulch', 'shave', 'sower', 'bribe', 'prank', 'psalm', 'dingy', 'radar', 'penne', 'nurse', 'blitz', 'quite', 'sheet', 'chili', 'plant', 'utile', 'abort', 'piano', 'flask', 'toddy', 'vapor', 'carol', 'spank', 'pinch', 'prick', 'basal', 'chide', 'aging', 'annex', 'tapir', 'elope', 'shuck', 'bigot', 'worse', 'smith', 'rover', 'safer', 'clown', 'baron', 'flout', 'incur', 'beret', 'shook', 'after', 'scrap', 'silly', 'erect', 'thyme', 'fetch', 'cinch', 'squat', 'azure', 'pinky', 'cello', 'showy', 'windy', 'preen', 'civil', 'flush', 'snore', 'tonal', 'shine', 'quota', 'bleep', 'stead', 'peace', 'tried', 'weigh', 'roger', 'polar', 'allay', 'there', 'floor', 'clout', 'gamma', 'blind', 'aphid', 'upper', 'burst', 'cider', 'vowel', 'valve', 'unzip', 'charm', 'brook', 'basil', 'craft', 'daddy', 'nobly', 'wedge', 'crick', 'bison', 'bacon', 'alloy', 'roach', 'sloth', 'weird', 'visor', 'gauze', 'alert', 'gnome', 'basis', 'place', 'watch', 'stink', 'scorn', 'apron', 'zonal', 'spoil', 'awake', 'foist', 'admin', 'unset', 'glean', 'chick', 'abled', 'udder', 'sight', 'fable', 'salad', 'flood', 'chuck', 'build', 'swash', 'pilot', 'solar', 'might', 'steed', 'wrung', 'cairn', 'troll', 'range', 'beech', 'gaily', 'ethos', 'dopey', 'stoic', 'risky', 'these', 'hotly', 'hippo', 'brush', 'comfy', 'myrrh', 'viper', 'burnt', 'knave', 'dusky', 'erode', 'gross', 'slope', 'plank', 'lanky', 'chafe', 'scoop', 'drawn', 'pubic', 'obese', 'rival', 'stain', 'crane', 'cadet', 'quake', 'squib', 'fishy', 'balmy', 'anime', 'sleep', 'razor', 'burly', 'chant', 'arbor', 'using', 'given', 'elegy', 'clamp', 'slain', 'blast', 'coral', 'briny', 'vault', 'trope', 'stoke', 'zebra', 'hobby', 'could', 'joust', 'woven', 'hinge', 'thumb', 'mirth', 'evade', 'amass', 'minus', 'erupt', 'thick', 'drove', 'lover', 'lumpy', 'maxim', 'plaza', 'ascot', 'recut', 'gloss', 'lance', 'loath', 'blurt', 'rearm', 'break', 'chair', 'eerie', 'foyer', 'newly', 'belly', 'metro', 'imbue', 'broke', 'verso', 'decal', 'neigh', 'creek', 'blink', 'orbit', 'crave', 'dodgy', 'satin', 'helix', 'clerk', 'amuse', 'fudge', 'olden', 'plaid', 'remit', 'scene', 'sonic', 'right', 'extra', 'cheap', 'raise', 'slime', 'goose', 'spire', 'twixt', 'purer', 'rumba', 'brisk', 'lobby', 'debut', 'witch', 'poser', 'event', 'mulch', 'hunch', 'reign', 'titan', 'trump', 'mount', 'swath', 'felon', 'where', 'wrath', 'round', 'meant', 'lumen', 'urban', 'vaunt', 'cover', 'cable', 'imply', 'cloak', 'tepee', 'dryly', 'hutch', 'snuck', 'sumac', 'homer', 'scout', 'women', 'brake', 'birch', 'abhor', 'rinse', 'vicar', 'fetal', 'salon', 'lever', 'hitch', 'koala', 'chirp', 'tasty', 'modem', 'gloat', 'viola', 'pushy', 'lower', 'froth', 'swill', 'haute', 'jetty', 'slash', 'spoon', 'spiny', 'resin', 'delve', 'heady', 'brown', 'phase', 'essay', 'pride', 'sheik', 'macho', 'willy', 'cease', 'nomad', 'venom', 'randy', 'stray', 'snipe', 'scion', 'furry', 'purge', 'nosey', 'disco', 'cargo', 'crypt', 'voila', 'tuber', 'lupus', 'assay', 'aloof', 'crest', 'bound', 'milky', 'rivet', 'slave', 'grape', 'snake', 'defer', 'salty', 'bully', 'shirk', 'bravo', 'rebar', 'angel', 'penal', 'twine', 'brawn', 'beard', 'wrote', 'seedy', 'issue', 'juror', 'suite', 'amply', 'seven', 'plain', 'creme', 'rhino', 'grime', 'dilly', 'fluke', 'quoth', 'miser', 'otter', 'amiss', 'bulky', 'brawl', 'scrub', 'shock', 'tardy', 'dirge', 'short', 'segue', 'gipsy', 'aside', 'check', 'husky', 'fancy', 'graft', 'atoll', 'graze', 'abate', 'super', 'tilde', 'today', 'lusty', 'daunt', 'novel', 'hippy', 'guide', 'clash', 'child', 'sadly', 'agile', 'latte', 'afire', 'wafer', 'stuff', 'aider', 'dealt', 'sedan', 'cobra', 'swarm', 'gripe', 'briar', 'salvo', 'perky', 'comma', 'spite', 'hefty', 'wheel', 'magma', 'cleat', 'payee', 'scaly', 'sunny', 'growl', 'pence', 'tiger', 'chock', 'piper', 'tweak', 'month', 'regal', 'steam', 'blurb', 'funky', 'meaty', 'satyr', 'movie', 'puree', 'cacao', 'biddy', 'grind', 'jumbo', 'wince', 'exalt', 'gamut', 'nasty', 'track', 'brass', 'epoch', 'bicep', 'tubal', 'raven', 'along', 'input', 'sooty', 'skill', 'focal', 'beast', 'decay', 'legal', 'fault', 'golly', 'stake', 'going', 'cower', 'kappa', 'shark', 'three', 'chasm', 'valor', 'outgo', 'cough', 'merge', 'bliss', 'doing', 'debug', 'wagon', 'cabin', 'house', 'poker', 'feign', 'space', 'about', 'deity', 'agate', 'jolly', 'unlit', 'cress', 'dusty', 'croak', 'wharf', 'fritz', 'buggy', 'hyper', 'offer', 'depth', 'fizzy', 'index', 'shell', 'pried', 'bongo', 'maize', 'owing', 'flack', 'heavy', 'force', 'vigil', 'horde', 'above', 'faith', 'stork', 'lofty', 'liege', 'intro', 'grill', 'await', 'skull', 'brick', 'torso', 'bathe', 'coach', 'mogul', 'swamp', 'fiery', 'globe', 'major', 'leaky', 'zesty', 'foray', 'stock', 'ebony', 'naval', 'guava', 'etude', 'dodge', 'bonus', 'wield', 'infer', 'enema', 'baton', 'march', 'filer', 'align', 'empty', 'druid', 'curvy', 'frond', 'gruff', 'krill', 'swish', 'bobby', 'smart', 'algae', 'slunk', 'gypsy', 'brand', 'excel', 'truck', 'tutor', 'quark', 'tidal', 'found', 'forty', 'abode', 'woozy', 'slate', 'pizza', 'curly', 'hardy', 'lunar', 'liner', 'rebus', 'pupil', 'kitty', 'graph', 'dunce', 'guard', 'light', 'inane', 'piggy', 'shade', 'taboo', 'again', 'dairy', 'pause', 'wooly', 'chart', 'grunt', 'niece', 'sushi', 'fairy', 'reply', 'album', 'began', 'silky', 'manic', 'screw', 'fried', 'morph', 'drone', 'finch', 'snail', 'angry', 'taper', 'baker', 'chump', 'drape', 'hello', 'goner', 'manly', 'idyll', 'north', 'picky', 'music', 'shiny', 'spike', 'lunch', 'crowd', 'final', 'llama', 'stiff', 'speed', 'topic', 'sheer', 'speck', 'slosh', 'stuck', 'corer', 'score', 'ditto', 'tarot', 'puppy', 'frame', 'dowel', 'berth', 'fibre', 'rerun', 'flank', 'bilge', 'steak', 'crude', 'smack', 'welch', 'cater', 'booze', 'cheer', 'snide', 'cyber', 'being', 'hotel', 'verse', 'derby', 'latch', 'coast', 'posit', 'pixie', 'fraud', 'small', 'manga', 'surer', 'arise', 'slump', 'swoon', 'hence', 'juicy', 'ennui', 'pouch', 'mushy', 'facet', 'punch', 'apply', 'moron', 'colon', 'petal', 'inlet', 'refer', 'smite', 'finer', 'snoop', 'arrow', 'odder', 'minty', 'store', 'amity', 'axiom', 'staff', 'hairy', 'gazer', 'black', 'shrug', 'argue', 'toxic', 'leach', 'weary', 'plush', 'spurt', 'credo', 'brain', 'dandy', 'putty', 'awash', 'blunt', 'micro', 'rehab', 'roomy', 'corny', 'idler', 'grown', 'class', 'borax', 'vapid', 'river', 'edict', 'shirt', 'gooey', 'query', 'geese', 'mercy', 'batty', 'tiara', 'fully', 'sprig', 'adobe', 'drown', 'racer', 'fella', 'allot', 'foggy', 'utter', 'holly', 'stalk', 'flung', 'reuse', 'lucky', 'tenet', 'whole', 'grain', 'mucky', 'papal', 'mural', 'throb', 'marry', 'exult', 'sigma', 'chalk', 'aunty', 'known', 'cloth', 'alone', 'elfin', 'gleam', 'moult', 'gaffe', 'droit', 'cheat', 'smell', 'freed', 'flirt', 'itchy', 'junto', 'share', 'shush', 'ovate', 'slack', 'comet', 'daisy', 'maple', 'happy', 'shady', 'begat', 'paste', 'vomit', 'gaunt', 'crate', 'tunic', 'stair', 'draft', 'heave', 'adage', 'delta', 'peach', 'slurp', 'terse', 'primo', 'whack', 'avert', 'swoop', 'vigor', 'karma', 'rebut', 'bitty', 'board', 'tweed', 'naive', 'match', 'tripe', 'scone', 'canny', 'spicy', 'awful', 'thrum', 'truce', 'denim', 'actor', 'patio', 'sweep', 'funny', 'girly', 'champ', 'hazel', 'yearn', 'panic', 'pound', 'queue', 'chaff', 'brief', 'twist', 'agent', 'robin', 'tally', 'thump', 'total', 'climb', 'renew', 'candy', 'boozy', 'shove', 'cabby', 'nutty', 'union', 'worth', 'sleek', 'cliff', 'cream', 'local', 'winch', 'moldy', 'chase', 'leggy', 'sport', 'drain', 'haste', 'swear', 'peril', 'steal', 'noose', 'yeast', 'clump', 'exile', 'serve', 'dummy', 'gully', 'ovoid', 'aloud', 'drawl', 'table', 'dread', 'equip', 'bunny', 'afoot', 'ninny', 'prone', 'masse', 'carve', 'plier', 'ingot', 'angle', 'siren', 'prowl', 'artsy', 'frail', 'mossy', 'frost', 'medal', 'howdy', 'scram', 'godly', 'salsa', 'shrub', 'tower', 'terra', 'condo', 'steel', 'mango', 'amaze', 'ranch', 'diver', 'worst', 'bugle', 'ditty', 'chime', 'rajah', 'frown', 'occur', 'axial', 'sheep', 'aroma', 'snack', 'greet', 'pulpy', 'pinto', 'waste', 'retch', 'point', 'drive', 'mower', 'lease', 'glove', 'sperm', 'prose', 'chute', 'anger', 'gourd', 'glaze', 'motor', 'wench', 'crass', 'error', 'undue', 'dozen', 'rally', 'matey', 'ruler', 'ahead', 'stool', 'yacht', 'jazzy', 'macro', 'guest', 'qualm', 'juice', 'barge', 'sewer', 'quirk', 'carry', 'atone', 'giddy', 'storm', 'groin', 'slick', 'clink', 'polyp', 'igloo', 'dogma', 'filth', 'cavil', 'hovel', 'baste', 'seize', 'midst', 'mangy', 'brine', 'shear', 'demon', 'erase', 'noble', 'scowl', 'omega', 'loamy', 'which', 'booty', 'ember', 'oddly', 'cutie', 'pooch', 'rabid', 'aback', 'state', 'scant', 'ridge', 'gusto', 'spine', 'wrest', 'scalp', 'paper', 'rifle', 'adept', 'loose', 'slice', 'abuse', 'title', 'shown', 'caste', 'linen', 'other', 'modal', 'puffy', 'heard', 'sheen', 'fetus', 'shaky', 'usual', 'fresh', 'pudgy', 'great', 'untie', 'suing', 'taker', 'spill', 'lingo', 'threw', 'shunt', 'fever', 'stank', 'rainy', 'femur', 'altar', 'bezel', 'cruel', 'liken', 'acorn', 'lemur', 'tatty', 'covey', 'trick', 'vouch', 'wimpy', 'overt', 'folio', 'octal', 'clove', 'enact', 'later', 'whine', 'blown', 'unify', 'mourn', 'amble', 'smear', 'rumor', 'fjord', 'recur', 'broil', 'fanny', 'pupal', 'extol', 'brash', 'begin', 'stall', 'knead', 'plate', 'outdo', 'oaken', 'water', 'mania', 'reedy', 'deuce', 'booth', 'fluff', 'flora', 'singe', 'valet', 'hymen', 'femme', 'aglow', 'tulip', 'whisk', 'plume', 'fetid', 'start', 'girth', 'abase', 'sharp', 'optic', 'ounce', 'elude', 'cocoa', 'joist', 'cache', 'crier', 'edify', 'circa', 'eagle', 'gawky', 'crumb', 'bawdy', 'eclat', 'repel', 'tease', 'swept', 'boxer', 'ruder', 'straw', 'halve', 'dimly', 'price', 'chain', 'badly', 'tense', 'manor', 'parer', 'pivot', 'trout', 'speak', 'caulk', 'stood', 'thief', 'hasty', 'spook', 'waxen', 'moose', 'navel', 'ocean', 'lucid', 'bused', 'spice', 'endow', 'whiny', 'smoke', 'snare', 'teddy', 'dwelt', 'alter', 'organ', 'olive', 'gusty', 'plump', 'patsy', 'floss', 'layer', 'teary', 'tabby', 'lager', 'fight', 'riper', 'upset', 'beach', 'roast', 'revue', 'pique', 'snaky', 'stack', 'focus', 'copse', 'block', 'caput', 'melee', 'salve', 'smile', 'taffy', 'chose', 'flash', 'paint', 'hunky', 'prove', 'chill', 'spied', 'scold', 'paddy', 'parse', 'churn', 'clear', 'guess', 'jewel', 'smote', 'gassy', 'bloom', 'young', 'flunk', 'stale', 'array', 'privy', 'ivory', 'clean', 'quote', 'kinky', 'chest', 'waist', 'squad', 'jelly', 'nerdy', 'south', 'rigid', 'debit', 'noisy', 'alien', 'cagey', 'stamp', 'polka', 'horse', 'banjo', 'until', 'snout', 'dally', 'harpy', 'kneel', 'musty', 'rhyme', 'cedar', 'trash', 'axion', 'unfit', 'skier', 'filet', 'thong', 'hussy', 'alike', 'spend', 'ample', 'fluid', 'trend', 'sieve', 'forth', 'gruel', 'relay', 'aisle', 'furor', 'truer', 'harem', 'logic', 'haunt', 'caper', 'panel', 'setup', 'still', 'carat', 'abbot', 'phony', 'email', 'lousy', 'miner', 'brood', 'couch', 'ninth', 'bless', 'tacit', 'expel', 'heath', 'soapy', 'stern', 'adore', 'apple', 'woken', 'madly', 'curio', 'lorry', 'tithe', 'gavel', 'asset', 'octet', 'beset', 'bagel', 'tulle', 'prune', 'camel', 'spree', 'curve', 'mauve', 'whale', 'cramp', 'wrist', 'smelt', 'pithy', 'minor', 'power', 'abyss', 'fruit', 'shoal', 'cigar', 'trace', 'inner', 'shyly', 'adopt', 'goofy', 'ficus', 'hurry', 'natal', 'usage', 'shank', 'shaft', 'cluck', 'stone', 'dried', 'ratty', 'stint', 'totem', 'dirty', 'crepe', 'stunt', 'filmy', 'grout', 'dumpy', 'duchy', 'choir', 'grace', 'hater', 'dying', 'bevel', 'prawn', 'leapt', 'pasty', 'demur', 'whirl', 'needy', 'wreck', 'saute', 'cameo', 'croup', 'lemon', 'below', 'ralph', 'crown', 'lunge', 'aware', 'afoul', 'frock', 'rusty', 'order', 'mecca', 'flint', 'enemy', 'umbra', 'groom', 'stump', 'venue', 'patty', 'cross', 'brink', 'sword', 'elite', 'offal', 'spell', 'older', 'rayon', 'glyph', 'giver', 'wound', 'pixel', 'leper', 'guilt', 'fauna', 'ramen', 'fleck', 'exert', 'tonic', 'staid', 'skunk', 'owner', 'saucy', 'revel', 'loyal', 'catty', 'envoy', 'dolly', 'piece', 'large', 'rapid', 'saint', 'eater', 'pygmy', 'shake', 'chess', 'press', 'clank', 'forte', 'harsh', 'icily', 'sorry', 'apart', 'spore', 'feast', 'probe', 'clung', 'gayly', 'glade', 'ninja', 'refit', 'leery', 'noise', 'scamp', 'audio', 'ledge', 'froze', 'sworn', 'clang', 'stark', 'elide', 'crawl', 'proxy', 'fewer', 'stave', 'fatal', 'donor', 'birth', 'blush', 'verge', 'ankle', 'khaki', 'drama', 'missy', 'blank', 'plumb', 'radii', 'coven', 'ombre', 'molar', 'arson', 'vivid', 'crank', 'gorge', 'sloop', 'pansy', 'learn', 'reset', 'emcee', 'fungi', 'among', 'vocal', 'wrack', 'sauce', 'adult', 'piety', 'fleet', 'group', 'tramp', 'rogue', 'fling', 'annul', 'knife', 'awoke', 'betel', 'digit', 'moral', 'scale', 'width', 'fiend', 'clack', 'fugue', 'guppy', 'elder', 'snort', 'borne', 'relic', 'idiot', 'tibia', 'allow', 'trice', 'tangy', 'dough', 'float', 'bough', 'broad', 'bleat', 'style', 'stoop', 'testy', 'sappy', 'dicey', 'botch', 'splat', 'rowdy', 'slung', 'vista', 'sooth', 'elect', 'attic', 'crime', 'triad', 'arena', 'whiff', 'minim', 'grail', 'trove', 'ought', 'shard', 'butte', 'widen', 'vague', 'icing', 'boule', 'flare', 'opium', 'siege', 'unity', 'sandy', 'wheat', 'curry', 'lilac', 'verve', 'shall', 'swung', 'mummy', 'mucus', 'death', 'strap', 'sneak', 'poesy', 'spout', 'joint', 'stand', 'bloke', 'sully', 'banal', 'badge', 'hilly', 'stage', 'diary', 'loopy', 'annoy', 'adorn', 'spurn', 'knelt', 'crust', 'jumpy', 'sever', 'favor', 'scree', 'comic', 'laugh', 'vital', 'tenth', 'jaunt', 'trait', 'acrid', 'trite', 'eight', 'flute', 'shame', 'reach', 'judge', 'ratio', 'dizzy', 'cumin', 'limbo', 'patch', 'beefy', 'blaze', 'uncut', 'tight', 'savor', 'ardor', 'grimy', 'havoc', 'deign', 'swell', 'plied', 'stony', 'kebab', 'fuzzy', 'bunch', 'quash', 'elate', 'scare', 'split', 'crush', 'sweat', 'downy', 'diner', 'close', 'flake', 'rouse', 'humph', 'mouse', 'prude', 'ready', 'swore', 'virus', 'idiom', 'inter', 'evoke', 'rocky', 'perch', 'grief', 'curse', 'nylon', 'boost', 'drink', 'tying', 'inbox', 'eject', 'gauge', 'ulcer', 'stunk', 'ensue', 'welsh', 'fifth', 'touch', 'evict', 'plait', 'drake', 'prize', 'lying', 'creak', 'maybe', 'madam', 'islet', 'sixth', 'mayor', 'moist', 'sting', 'purse', 'crock', 'avail', 'munch', 'tepid', 'kayak', 'filly', 'mammy', 'guile', 'merry', 'buxom', 'blond', 'relax', 'clasp', 'cheek', 'dress', 'bluer', 'braid', 'scarf', 'savoy', 'anvil', 'mocha', 'audit', 'print', 'acute', 'spiel', 'onset', 'scour', 'dully', 'wacky', 'askew', 'notch', 'gummy', 'alley', 'vying', 'theta', 'meter', 'alibi', 'witty', 'swift', 'shorn', 'slimy', 'flock', 'sweet', 'radio', 'groan', 'binge', 'lyric', 'clock', 'spool', 'click', 'pitch', 'smock', 'truss', 'their', 'every', 'vodka', 'built', 'unmet', 'lurch', 'surly', 'agape', 'rural', 'broth', 'motel', 'inlay', 'drank', 'humor', 'decry', 'livid', 'sound', 'model', 'catch', 'decoy', 'datum', 'savvy', 'ideal'];
    var Ta = [
        "aahed",
        "aalii",
        "aargh",
  ...
  ***************************************************************************** */
                          ...
                          return (
                            ...
                            }),
                            {
                              text: ""
                                ...
                                .concat(
                                  "\nPlay at " +
                                    window.location.origin + `?n=${wordlenumber}`
                                ),
                            }
                          );
                        })({
    ...
    Ps.innerHTML =
      '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Guess the <strong>WORDLE</strong> in 6 tries.</p>\n      <p>Each guess must be a valid 5 letter word. Hit the enter button to submit.</p>\n      <p>After each guess, the color of the tiles will change to show how close your guess was to the word, and the letters will disappear.</p>\n      <div class="examples">\n        <p><strong>Examples</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="w" evaluation="correct" reveal></game-tile>\n<game-tile letter="i" evaluation="absent" reveal></game-tile><game-tile letter="n" evaluation="absent" reveal></game-tile><game-tile letter="d" evaluation="absent" reveal></game-tile><game-tile letter="y" evaluation="absent" reveal></game-tile>\n          </div>\n          <p>You guessed the correct letter in the first position.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="p" evaluation="absent" reveal></game-tile>\n<game-tile letter="i" evaluation="present" reveal></game-tile><game-tile letter="l" evaluation="absent" reveal></game-tile><game-tile letter="l" evaluation="absent" reveal></game-tile><game-tile letter="s" evaluation="absent" reveal></game-tile>\n          </div>\n          <p>The letter you guessed in the second position is in the word, but not at that spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="v"></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="g"></game-tile>\n            <game-tile letter="u" evaluation="absent" reveal></game-tile>\n            <game-tile letter="e"></game-tile>\n          </div>\n          <p>The letter <strong>U</strong> is not in the word in any spot.</p>\n        </div>\n      </div>\n      <p><strong>To play another, just reload the page.<strong></p>\n    </div>\n  </section>\n';
    var Hs = (function (e) {
      r(t, e);
      var a = h(t);
      function t() {
