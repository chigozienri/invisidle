(this.wordle = this.wordle || {}),
  ...
  ***************************************************************************** */
    ...
    var Is = document.createElement("template");
    Is.innerHTML =
      '\n  <div class="countdown">\n    <button class="random" onclick="window.location.href = baseurl"><h1>Get new Invisidle</h1></button>\n    </div>\n  <div class="share">\n    <button class="share-button"><h1>Share</h1></button>\n  </div>\n';
    var Ms = {
